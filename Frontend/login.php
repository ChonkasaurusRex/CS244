    ...
    <body>
        ...
        <div class="lgn">
            ...
            <form method="post" action="<?php if($red==true && $uval=="a"){
                header("Location: http://localhost/CS244/Controller/LinkAdmin.php");
                $_SESSION['ID'] = $utype;
            }
            elseif($red==true && $uval=="s"){
                header("Location: http://localhost/CS244/Controller/LinkStudent.php");
                $_SESSION['ID'] = $utype;
            }
            elseif($red==true && $uval=="t"){
                header("Location: http://localhost/CS244/Controller/LinkTeacher.php");
                $_SESSION['ID'] = $utype;
            }
            elseif($red==true && $uval=="p"){
                header("Location: http://localhost/CS244/Controller/LinkAccountant.php");
                $_SESSION['ID'] = $utype;
            }
            elseif ($red==false){
