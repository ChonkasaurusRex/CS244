...
<html>
    ...
    <?php
        ...
        function SearchEm($file,$sendEM,&$val){
        ...
        if($val==false){
            SearchEm("../Invoices/Admin.txt",$sendEM,$val);
            SearchEm("../Invoices/Student.txt",$sendEM,$val);
            SearchEm("../Invoices/Teacher.txt",$sendEM,$val);
            SearchEm("../Invoices/Accountant.txt",$sendEM,$val);
        }
    ?>
    <body>
        <hr id="navsep"></hr>
